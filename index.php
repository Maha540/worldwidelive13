...
<body>
	...
	<div class="hero">
		<nav>
			<h2 class="logo">Worldwide<span>Live</span></h2>
			<ul>
				<li><a href="#">Home</a></li>
		...
		<div class="content">
			...
			<h1>Worldwide <span>Live</span></h1>
	...
	<div class="service">
		...
		<div class="box">
			<div class="card">
				...
				<h5>Bussiness With WW Live</h5>
				<div class="pra">
					<p>Every website should be built with two primary goals: Firstly, it needs to work across all devices. Secondly, it needs to be fast as possible.</p>

					<p style="text-align: center;">
						<a class="button" href="#">Go To Where</a>
					</p>
				</div>
			</div>
	...
	<div class="contact-me">
		<p>Let Me Get You To The Worldwide Live.</p>
		<a class="button-two" href="#">Sign Up</a>
	</div>

	<!------footer start--------->
	<footer>
		<p>World Wide Live</p>
		<p>Find more places at once</p>
		<div class="social">
			<a href="#"><i class="fab fa-facebook-f"></i></a>
			<a href="#"><i class="fab fa-instagram"></i></a>
			<!-- <a href="#"><i class="fab fa-dribbble"></i></a> -->
		</div>
		<p class="end">CopyRight By Worldwide Live</p>
	</footer>
</body>
</html>